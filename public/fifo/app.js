...
(() => {
  ...
  const TRAVEL_KEYS = {
    ...
    boardingOriginal: 'fifo_boarding_pass_original_v1',
  };
  ...
  const actions = {
    ...
    'boarding-zoom':        openBoardingZoom,
    'close-boarding-zoom':  closeBoardingZoom,
    'boarding-crop':        openBoardingCropSheet,
    'close-boarding-crop':  closeBoardingCropSheet,
    'boarding-crop-apply':  boardingCropApply,
    'boarding-crop-reset':  boardingCropReset,
